...
(16, 'ฟาร์ม แถวบ้าน', '123', 6774, 7),
(17, 'test', '123', 123131, 7);
...
(7, '1160400251822', 'ศราวุธ อวดกล้า', 'u.sarawut586@gmail.com', '0979284920', 'suit03.jpg', 'user1', '$argon2i$v=19$m=65536,t=4,p=1$Si5rOXR0L0JkYVBvTXg2aA$UsZou9JIMSONegNpHeVJGa387cnZXOVGRBOeACho+s8', '2022-01-23 16:21:36');
...
--
-- Dumping data for table `tbl_herd`
--

INSERT INTO `tbl_herd` (`id`, `herd_name`, `house_id`) VALUES
(1, 'ทดสอบ', 6);
...
INSERT INTO `tbl_house` (`id`, `house_name`, `farm_id`) VALUES
(6, 'TXRC03', 1),
(7, 'TRXC04', 6);
...
--
ALTER TABLE `tbl_farm`
  MODIFY `id` smallint(6) NOT NULL AUTO_INCREMENT COMMENT 'รหัสฟาร์ม', AUTO_INCREMENT=18;

--
-- AUTO_INCREMENT for table `tbl_farmer`
--
ALTER TABLE `tbl_farmer`
  MODIFY `id` int(6) NOT NULL AUTO_INCREMENT COMMENT 'รหัสเจ้าของฟาร์ม', AUTO_INCREMENT=9;
...
--
ALTER TABLE `tbl_herd`
  MODIFY `id` smallint(6) NOT NULL AUTO_INCREMENT COMMENT 'รหัสฝูงโค', AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `tbl_house`
--
ALTER TABLE `tbl_house`
  MODIFY `id` smallint(6) NOT NULL AUTO_INCREMENT COMMENT 'รหัสโรงเรือน', AUTO_INCREMENT=8;
...
COMMIT;
'2019-08-09 03:33:09', '2019-08-09 03:33:09', NULL),
