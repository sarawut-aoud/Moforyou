        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1>ManagePages ประสิทธิภาพอาหาร</h1>
                        </div>
                        <div class="col-sm-6">
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header card-outline card-blue">
                                    <h3 class="text-center">ประสิทธิภาพอาหาร</h3>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body">
                                    <!-- table -->
                                    <table id="example1" class="table table-bordered table-striped table-hover">
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th>อาหาร</th>
                                                <th>ชื่อโค</th>
                                                <th>น้ำหนักก่อนให้</th>
                                                <th>น้ำหนักหลังให้</th>
                                                <th>Edit&Delete</th>
                                            </tr>
                                        </thead>
                                        <!-- /.head table -->
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <center>
                                                    <a class="btn btn-info" data-toggle="modal" data-target="#md-food" >
                                                            <i class="fas fa-pencil-alt"></i>
                                                        </a>
                                                        <?php require '../modal/md_food.php';?>
