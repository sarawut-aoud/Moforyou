                                ...
                                <div class="card  ">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class=" text-end mb-3">
                                            <a href="../pdf/pdf_cow.php?farm=<?php echo $farmid; ?>"class="btn btn-outline-danger "><img src="../../dist/img/icon/pdf.png" width="40px"></a>
                                            <a href="../print/print_cow.php?farm=<?php echo $farmid; ?>"class="btn btn-outline-primary "><img src="../../dist/img/icon/printer.png" width="40px"></a>
                                        </div>
